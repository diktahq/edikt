...
This guide teaches you how to write effective Invariant Records. Read the [ADR-009 coinage doc](../../decisions/ADR-009-invariant-record-terminology.md) for the formal terminology and [`invariant-record-template.md`](invariant-record-template.md) for the template structure. This guide is about **how to write good ones**.
...
See [`canonical-examples/tenant-isolation.md`](canonical-examples/tenant-isolation.md) for the full file.
...
See [`canonical-examples/money-precision.md`](canonical-examples/money-precision.md) for the full file.
...
- [ADR-008](../../decisions/ADR-008-deterministic-compile-and-three-list-schema.md) — The three-list directive schema and hash caching contract
- [ADR-009](../../decisions/ADR-009-invariant-record-terminology.md) — The formal coinage of "Invariant Record"
- [`invariant-record-template.md`](invariant-record-template.md) — The authoritative template
- [`canonical-examples/tenant-isolation.md`](canonical-examples/tenant-isolation.md) — Full annotated example 1
- [`canonical-examples/money-precision.md`](canonical-examples/money-precision.md) — Full annotated example 2
