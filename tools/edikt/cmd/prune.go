...
always protected regardless of sort position.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		// toKeep is implied: the first pruneKeep entries in `tags` (sorted
		// newest-first) stay. We only materialize toPrune since that's what
		// the subsequent loop consumes.
		var toPrune []string
