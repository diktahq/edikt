...
func TestMigrateNothingToDo(t *testing.T) {
	...
	// v0.6.0+ layout: versions/<v> dir exists, no real hooks/ dir.
	vdir := filepath.Join(root, "versions", "0.6.0")
...
// On a v0.6.0 layout with a CLAUDE.md containing HTML sentinels, running
...
func TestMigrateAbortNoProgress(t *testing.T) {
	...
	// Minimal v0.6.0 layout (no staging/predir dirs).
