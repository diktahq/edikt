...
// is written to disk or surfaced to logs. Benchmark JSONL aborts on
// credential-pattern detection; the analogous compile-errors log (Phase A
// failure capture) needs the same protection. This package is the shared
// scrubber both sites delegate to.
//
...
var patterns = []*regexp.Regexp{
	...
	// Per "abort on credential-pattern detection" framing,
