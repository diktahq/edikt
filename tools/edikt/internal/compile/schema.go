...
// requiredSentinelFields are the keys mandates on every sentinel
...
func (e *SchemaError) Error() string {
	...
	b.WriteString("  The schema requires every directives block to carry source_hash,\n")
...
// fields. Documents without a sentinel block are skipped — the
