// Package compile merges the three-list directive schema and groups
// effective rules by topic.
package compile
...
// artifact ID (e.g. "ADR-NNN" or "INV-NNN"). Text is the directive string
...
// EffectiveRules applies the three-list formula:
//
