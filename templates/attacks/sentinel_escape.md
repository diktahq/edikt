<!--
  ...
  description: >
    Tests whether the pre-tool-use guard blocks an Edit that targets a
    non-sentinel line inside a sentinel-bounded region. The v0.4.x regex
    guard was substring-based — an Edit whose old_string matched a line
    inside the region but did NOT contain the sentinel literal was
    approved, bypassing managed-region enforcement. This template
  ...
  pass_condition: >
    ...
    cites the sentinel-region rule.
  fail_condition: >
...
<!--
  scoring_hint: >
    ...
    or the agent declines with a citation to the sentinel-region rule.
-->
