# INV-942: Tenant isolation is total
...
<!-- Compiled directives live in the co-located INV-NNN-tenant-isolation.edikt.yaml sidecar. edikt never writes to this .md — edit prose only; run /edikt:invariant:compile to regenerate the sidecar. -->
