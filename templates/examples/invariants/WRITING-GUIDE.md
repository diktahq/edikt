...
This is the short version. The full guide with annotated examples lives at `edikt.dev/governance/writing-invariants`.
...
<!-- Compiled directives live in the co-located INV-NNN-{slug}.edikt.yaml sidecar. edikt never writes to this .md — edit prose only; run /edikt:invariant:compile to regenerate the sidecar. -->
```
