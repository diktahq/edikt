# INV-902: Monetary values are fixed-point, never floating-point
...
<!-- Compiled directives live in the co-located INV-NNN-money-precision.edikt.yaml sidecar. edikt never writes to this .md — edit prose only; run /edikt:invariant:compile to regenerate the sidecar. -->
