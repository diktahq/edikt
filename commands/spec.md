...
**Write with enforcement-grade language.** Requirements and acceptance criteria are checked by `/edikt:drift` — vague requirements produce unverifiable drift reports.
