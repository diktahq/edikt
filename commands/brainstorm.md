...
**Grounded mode:** Connect to project context. Reference relevant ADRs, invariants, active specs, and existing architecture. Example: "We have ADR-NNN about X — does this interact with that?", "The current spec-artifacts flow does Y — is this related?"
