...
```
Usage: /edikt:sdlc:prd-review PRD-NNN
```
And stop.
...
PRD REVIEW — PRD-NNN
  ...
  ⚠ Broken references ({count}):
    ...
    • SPEC-942 — not found in {specs_dir}/
...
End with a one-line verdict, e.g. `✅ PRD-NNN reviewed: 14/15 — PASS, 0 gaps, 0 broken refs`.
