...
**Full methodology, pre-registration, and hypothesis:** see [`docs/internal/product/prds/PRD-001-spec/experiments/`](../../docs/internal/product/prds/PRD-001-spec/experiments/) in the source tree.
...
See the full methodology at [`docs/internal/product/prds/PRD-001-spec/experiments/README.md`](../../docs/internal/product/prds/PRD-001-spec/experiments/README.md). Key commitments:
...
Results live in `results/{experiment-id}-{date}/`. See `runner-spec.md` in the PRD-001-spec for the reporting format.
