# Results — 08-long-context-invoicing
...
- **Baseline (no invariant):** 1 / 2 violations
- **Invariant-loaded:** 0 / 2 violations
- **Delta:** 1 (positive = invariant helped)

## Hypothesis verdict

✅ **Effect confirmed**

Baseline failure rate exceeded the threshold (1+) and invariant-loaded rate dropped to ≤1.
