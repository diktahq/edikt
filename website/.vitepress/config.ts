...
export default withMermaid(defineConfig({
  ...
  rewrites: {
    ...
    'commands/review': 'commands/sdlc/code-review',
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Sidecar Architecture', link: '/governance/sidecar' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Upgrading to v0.7.0', link: '/guides/v0.7.0-upgrade' },
          { text: 'Sidecar Migration', link: '/guides/sidecar-migration' },
          { text: 'The PRD Format', link: '/guides/prd-v2' },
          { text: 'Configuring Evaluator Gates', link: '/guides/evaluator-gates' },
          { text: 'Falsifiable Verification', link: '/guides/falsifiable-verification' },
        ],
      },
      {
        text: 'Experiments',
        ...
        items: [
          {
            ...
            items: [
              ...
              { text: 'gov:grade-compile', link: '/commands/gov/grade-compile' },
              { text: 'gov:review', link: '/commands/gov/review' },
              { text: 'gov:reextract', link: '/commands/gov/reextract' },
              { text: 'gov:advisory-review', link: '/commands/gov/advisory-review' },
              { text: 'gov:score', link: '/commands/gov/score' },
              { text: 'gov:benchmark', link: '/commands/gov/benchmark' },
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'sdlc:prd-review', link: '/commands/sdlc/prd-review' },
              { text: 'sdlc:spec', link: '/commands/sdlc/spec' },
              { text: 'sdlc:spec-review', link: '/commands/sdlc/spec-review' },
              { text: 'sdlc:artifacts', link: '/commands/sdlc/artifacts' },
              { text: 'sdlc:plan', link: '/commands/sdlc/plan' },
              { text: 'sdlc:code-review', link: '/commands/sdlc/code-review' },
              { text: 'sdlc:drift', link: '/commands/sdlc/drift' },
              { text: 'sdlc:audit', link: '/commands/sdlc/audit' },
              { text: 'sdlc:post-flight', link: '/commands/sdlc/post-flight' },
            ],
          },
          {
            text: 'Decisions',
            items: [
              ...
              { text: 'adr:enrich', link: '/commands/adr/enrich' },
              ...
              { text: 'guideline:compile', link: '/commands/guideline/compile' },
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: 'edikt verify', link: '/commands/verify' },
              { text: 'edikt gov verify-diff', link: '/commands/gov/verify-diff' },
              { text: 'edikt migrate sidecars', link: '/commands/migrate' },
              { text: 'edikt migrate to-v2', link: '/commands/migrate#edikt-migrate-to-v2' },
              { text: 'sidecar:approve', link: '/commands/sidecar/approve' },
            ],
          },
        ],
      },
