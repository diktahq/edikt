...
- [/edikt:sdlc:plan](/commands/sdlc/plan) — generate phased execution plan with pre-flight specialist review
- [/edikt:sdlc:drift](/commands/sdlc/drift) — verify implementation against these artifacts after building
