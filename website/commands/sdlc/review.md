...
```bash
/edikt:sdlc:review                    ← review last commit
/edikt:sdlc:review --staged           ← review staged changes
/edikt:sdlc:review --branch           ← review all changes on this branch
/edikt:sdlc:review src/payments/      ← review a specific directory
```
...
After implementing a feature, `edikt:sdlc:review` inspects what changed and automatically routes to the specialist agents whose domain was touched — without you having to know which agents exist or which to ask.
