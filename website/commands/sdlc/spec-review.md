...
```bash
/edikt:sdlc:spec-review SPEC-005
```
...
SPEC REVIEW — SPEC-005
  ...
  ⚠ Broken references (1):
    • ADR-942 — not found in docs/architecture/decisions/

Next:
  • Revise SPEC:        /edikt:sdlc:spec PRD-005
  • Review linked PRD:  /edikt:sdlc:prd-review PRD-005
...
- [/edikt:sdlc:prd-review](/commands/sdlc/prd-review) — re-score the source PRD
