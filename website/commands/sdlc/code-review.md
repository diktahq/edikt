...
/edikt:sdlc:code-review --staged           ← review staged changes
/edikt:sdlc:code-review --branch           ← review all changes on this branch
/edikt:sdlc:code-review src/payments/      ← review a specific directory
```
...
After implementing a feature, `edikt:sdlc:code-review` inspects what changed and automatically routes to the specialist agents whose domain was touched — without you having to know which agents exist or which to ask.
