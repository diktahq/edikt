...
```bash
/edikt:docs:review                  ← show pending doc gaps
/edikt:docs:review audit            ← full sweep with fixes
/edikt:docs:review audit api        ← API routes vs API docs only
/edikt:docs:review audit readme     ← env vars, install steps, deps vs README
/edikt:docs:review audit infra      ← docker-compose, k8s, queues vs infra docs
```
