...
- Fix diverged findings and run `/edikt:drift` again
- [/edikt:review](/commands/review) — specialist review for the current implementation
- [/edikt:audit](/commands/audit) — OWASP and security audit
